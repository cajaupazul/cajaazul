...
fs.writeFileSync('./parser-temp.js', jsCode);

const { parseLines } = require('./parser-temp.js');
...
console.log('\\n--- JSON ---');
console.log(JSON.stringify(result.filter(o => o.seccion === 'A' || o.seccion === 'K'), null, 2));
