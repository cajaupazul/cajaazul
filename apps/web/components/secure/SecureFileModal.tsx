    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
            <DialogContent 
                ...
                className="p-0 overflow-visible bg-[#f5f5f5] border-none shadow-2xl text-white w-full h-[100dvh] max-w-none sm:w-[95vw] md:w-[92vw] lg:w-[1200px] fixed rounded-none z-[99999] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:slide-in-from-right-full data-[state=closed]:slide-out-to-right-full duration-700 ease-out [&>button]:text-white [&>button]:hover:text-white [&>button]:hover:bg-slate-800 [&>button]:bg-[#0B132B] [&>button]:rounded-none [&>button]:w-12 [&>button]:h-12 [&>button]:flex [&>button]:items-center [&>button]:justify-center [&>button]:!right-auto [&>button]:!-left-12 [&>button]:!top-0 [&>button]:transition-all [&>button]:z-[999999] [&>button]:shadow-lg [&>button]:opacity-100"
            >
