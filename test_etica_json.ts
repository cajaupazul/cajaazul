...
import { parseLines, OfertaAcademica } from './apps/web/lib/pdf-schedule-parser';
...
console.log('Result for Section A:');
console.log(JSON.stringify(result.filter(o => o.seccion === 'A'), null, 2));

console.log('\\nResult for Section K:');
console.log(JSON.stringify(result.filter(o => o.seccion === 'K'), null, 2));

const allSections = new Set(result.map(o => o.seccion));
console.log('\\nAll Sections parsed:');
console.log(Array.from(allSections).sort());
